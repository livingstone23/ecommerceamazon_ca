        ...
        )
    {
        try 
        {
            ...
            if (!usuarioManager.Users.Any()) 
            {
                ...
                await usuarioManager.CreateAsync(usuarioAdmin, "LCANOabc123***");
                ...
                var usuario = new Usuario 
                {
                    Nombre = "Rodolfo",
                    Apellido = "Cano",
                    Email = "lcano@gmail.com",
                    UserName = "Rcano",
                    Telefono = "123456789",
                    AvatarUrl = "123"
                };
                await usuarioManager.CreateAsync(usuario, "LCANOabc123***");
            ...
            {
                var reviewData = File.ReadAllText("../Infrastructure/Data/image.json");
