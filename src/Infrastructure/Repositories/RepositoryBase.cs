...
public class RepositoryBase<T> : IAsyncRepository<T> where T : class
{
    ...
    #region  Implementacion_MetodosGenericos


        //Inserta el record en memoria y en la base de datos
        ...
        //Inserta el registro solo en la memoria del servidor de aplicacion.
    ...
    #region  Implementacion_MetodosGenericos_ConEspecificaciones
        ...
        //Retorna un solo registro en base a la especificacion.
        public async Task<T> GetByIdWithSpec(ISpecification<T> spec)
        {
            return (await ApplySpecification(spec).FirstOrDefaultAsync())!;
        }

        //metodo de apoyo para los anteriores, permite conocer cantidad de records de las consultas para los metodos con especificaciones
