...
public class OrderController: ControllerBase 
{
    ...
    /// <summary>
    /// Metodo que permite obtener todas las ordenes de un usuario
    /// </summary>
    ...
    {
        //Obtenemos el usuario de la sesion, solo los autenticados pueden acceder a este metodo
    ...
    /// <summary>
    /// Metodo que permite obtener las ordenes para un usuario administrador
    /// </summary>
    /// <param name="paginationOrdersParams"></param>
    /// <returns></returns> <summary>
    [Authorize(Roles = Role.ADMIN)]
